...
const registerSchema = yup.object().shape({
	firstName: yup.string().required("required"), //check if this allws symbols in name
...
const Form = () => {
	...
	const register = async (values, onSubmitProps) => {
		...
		//the name of the picture is the path as all the pictures are in our local storage server/public/assets
